...
namespace ShellContextMenu
{
    ...
    [Guid("F3869E38-A087-4D4F-A4B5-47F1712B735F"), ComVisible(true)]
    public class DecryptMenuItem : IShellExtInit, IContextMenu
    {
        // The name of the selected file.
        private string selectedFile;

        private string menuText = "Раскодировать и проверить подпись";
        private IntPtr menuBmp = IntPtr.Zero;
        private string verb = "DecryptAndIdentify";
        private string verbCanonicalName = "DVM";
        private string verbHelpText = "Раскодировать закрытый файл и инфицировать подпись";
        private uint IDM_DISPLAY = 1;

        public DecryptMenuItem()
        {
            // Load the bitmap for the menu item.
            Bitmap bmp = Resources.Unlock;
