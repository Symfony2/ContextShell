...
namespace ShellContextMenu
{
    ...
    public class EncryptMenuItem : IShellExtInit, IContextMenu
    {
        // The name of the selected file.
        private string selectedFile;

        private string menuText = "Закрыть и подписать";
        private IntPtr menuBmp = IntPtr.Zero;
        private string verb = "EncryptAndSign";
        private string verbCanonicalName = "ESM";
        private string verbHelpText = "Закрыть файл и подисать файл электронно цифровой подписью";
        private uint IDM_DISPLAY = 0;

        public EncryptMenuItem()
        {
            // Load the bitmap for the menu item.
            Bitmap bmp = Resources.Lock;
